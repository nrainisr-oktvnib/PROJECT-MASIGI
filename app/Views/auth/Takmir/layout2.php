...
<head>
  ...
  <!-- base:css -->
  <link rel="stylesheet" href="/temp2/vendors/mdi/css/materialdesignicons.min.css">
  <link rel="stylesheet" href="/temp2/vendors/base/vendor.bundle.base.css">
  <!-- endinject -->
...
<body>
        ...
        <div class="container-fluid">
          <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between">
            ...
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
              <a class="navbar-brand brand-logo" href="index.html"><img src="/img/logo-black-shadow.png" alt="logo" /></a>
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item nav-profile dropdown">
                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
                  ...
                  <img src="/img/takmir.jpeg" alt="profile" />
                </a>
  ...
  <!-- container-scroller -->
  <!-- base:js -->
  <script src="/temp2/vendors/base/vendor.bundle.base.js"></script>
  <!-- endinject -->
  <!-- Plugin js for this page-->
  <!-- End plugin js for this page-->
  <!-- inject:js -->
  <script src="/temp2/js/template.js"></script>
  <!-- endinject -->
  <!-- plugin js for this page -->
  <!-- End plugin js for this page -->
  <script src="/temp2/vendors/chart.js/Chart.min.js"></script>
  <script src="/temp2/vendors/progressbar.js/progressbar.min.js"></script>
  <script src="/temp2/vendors/chartjs-plugin-datalabels/chartjs-plugin-datalabels.js"></script>
  <script src="/temp2/vendors/justgage/raphael-2.1.4.min.js"></script>
  <script src="/temp2/vendors/justgage/justgage.js"></script>
  <script src="/temp2/js/jquery.cookie.js" type="text/javascript"></script>
  <!-- Custom js for this page-->
  <script src="/temp2/js/dashboard.js"></script>
